...
import paediatricsSurgeryImg from "../../assets/images/specialities-offer/Pediatric-about.jpg";
...
export default function PaediatricsSurgery() {
  return (
    <SpecialityBase
      title="Paediatrics Surgery"
      aboutTitle="Paediatrics Surgery Department"
      aboutDescription="This department specializes in the healthcare needs of children across all stages of life, from adolescence to menopause and beyond. It provides a wide range of services including preventive care, reproductive health consultations, prenatal and postnatal care, and the treatment of gynecological conditions and disorders."
      aboutImage={paediatricsSurgeryImg}
      slides={slides}
      backseat={backseat}
      backseatBg={backseatBg}
      img="https://images.unsplash.com/photo-1578496781379-7dcfb995293d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8UGFlZGlhdHJpY3MlMjBTdXJnZXJ5fGVufDB8fDB8fHww"
    />
  );
}
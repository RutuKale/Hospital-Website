...
export default function Pulmonology() {
  return (
    <SpecialityBase
      title="Pulmonology"
      aboutTitle="Pulmonology Department"
      ...
      img="https://images.unsplash.com/photo-1737967070342-bf2a0f3ff52c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fFB1bG1vbm9sb2d5fGVufDB8fDB8fHww"
    />
  );
}
...
import urologyImg from "../../assets/images/specialities-offer/Urology-about.jpg";
...
export default function Urology() {
  return (
    <SpecialityBase
      title="Urology"
      aboutTitle="Urology Department"
      aboutDescription="This department specializes in the care of infants, children, adolescents, and provides a range of services including preventive care, developmental screenings, and treatment of childhood illnesses and conditions."
      aboutImage={urologyImg}
      slides={slides}
      backseat={backseat}
      backseatBg={backseatBg}
      img="https://plus.unsplash.com/premium_photo-1702598564277-0984e20bafb7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8VXJvbG9neXxlbnwwfHwwfHx8MA%3D%3D"
    />
  );
}
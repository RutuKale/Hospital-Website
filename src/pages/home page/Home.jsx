...
import heroVideo from '../../assets/videos/home-hero-section.mp4';
...
const valuesData = [
    {
        ...
        content: "We know that seeking medical care can feel stressful, so we focus on creating a warm and supportive environment. With empathy and compassion, we ensure every patient feels cared for and at ease.",
        icon: (
            <svg className="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
        ...
        content: "We uphold integrity in every aspect of care, ensuring honesty, transparency, and trust with our patients. Through continuous learning and improvement, we stay committed to delivering the highest quality medical services.",
        icon: (
            <svg className="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
        ...
        content: "We are dedicated to achieving excellence in clinical outcomes through advanced treatments, evidence-based practices, and patient-centered care. By prioritizing safety, precision, and innovation, we ensure the best possible results for every patient.",
        icon: (
            <svg className="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
        ...
        content: "We place patients at the heart of everything we do, treating every individual with dignity, respect, and compassion. Our approach ensures personalized care that values each person’s unique needs and circumstances.",
        icon: (
            <svg className="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
        ...
        content: "We are committed to continuous innovation and learning, adopting the latest medical advancements and best practices. By enhancing our knowledge and skills, we ensure patients receive comprehensive, effective, and up-to-date care.",
        icon: (
            <svg className="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-col min-h-screen">
                ...
                <section className="relative w-full h-[100vh] overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
                        ...
                        <p className="text-sm sm:text-base md:text-lg max-w-xl">
                            Providing world-class healthcare with compassion and advanced technology.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-10 sm:py-12 md:py-14 lg:py-16 bg-gradient-to-b from-white to-gray-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="text-center mb-12">
                            ...
                            >
                                Numbers that reflect our commitment to providing exceptional medical care
                            </motion.p>
                        </div>
                ...
                <section className="relative py-10 sm:py-12 md:py-14 lg:py-16 bg-gray-50 h-[500px] md:min-h-[700px] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute bottom-10 w-[85%] md:w-[80%] max-w-6xl translate-y-1 z-20">
                        <div data-aos="fade-up" className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.18)] hover:shadow-[0_30px_70px_rgba(0,0,0,0.25)] transition-shadow duration-300 p-4 sm:p-8 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-4 border border-gray-100">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 w-full md:w-auto">
                                <div className="flex items-center gap-2 md:gap-4">
                                    ...
                                    <div className="text-left md:text-left">
                                        <p className="text-sm md:text-base text-gray-500 font-semibold uppercase tracking-wider">Emergency</p>
                                        <p className="text-sm sm:text-base md:text-lg font-bold text-gray-900">+91 9876543210</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2 md:gap-4">
                                    ...
                                    <div className="text-left md:text-left">
                                        <p className="text-sm md:text-base text-gray-500 font-semibold uppercase tracking-wider">Location</p>
                                        <p className="text-sm sm:text-base md:text-lg font-bold text-gray-900">IT Park, Viman Nagar, Pune, Maharashtra, India</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
                        <div className="flex flex-col lg:flex-row gap-10 md:gap-16 items-center">
                            ...
                            <div data-aos="fade-right" className="lg:w-1/2">
                                <span className="text-blue-600 font-bold uppercase tracking-wider text-sm">About PIMS Multi Super-Speciality Hospital</span>
                                ...
                                <p className="text-sm sm:text-base md:text-lg text-gray-600 text-gray-600 mb-2 leading-relaxed text-justify">
                                    <span className={`${!isExpanded ? "line-clamp-4 md:line-clamp-none" : ""}`}>
                                        PIMS Multi Super-Speciality Hospital is a 100-bed healthcare destination in Udaipur, where advanced medical technology meets the compassion every patient deserves. Our team of highly skilled specialists, supported by state-of-the-art surgical equipment and modern diagnostics, delivers care that goes beyond treating conditions, we work to restore health, rebuild lives, and strengthen our community.
                                        <br /><br />
                                        Bringing decades of medical expertise to the heart of Udaipur, we are committed to ensuring that every resident has access to world-class healthcare close to home. At PIMS, we believe every case carries a human story, and that’s why we have created more than just a hospital, we’ve built a place where innovation and empathy come together to deliver results that truly matter.
                                    </span>
                                </p>
                                ...
                                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-2 md:mb-4">Our Special Features</h3>
                                <div className="grid grid-cols-1 sm:grid-cols-2 mb-4 md:mb-6">
                                    {[
                                        ...
                                        <div key={index} className="flex items-center text-sm sm:text-base md:text-lg text-gray-600 text-gray-700">
                                            <svg className="md:w-5 md:h-5 h-4 w-4 text-blue-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <button className="relative overflow-hidden border-2 border-blue-600 text-blue-600 px-4 sm:px-6 md:px-6 py-1 sm:py-2 md:py-3 text-sm sm:text-base md:text-lg rounded-full font-bold group inline-flex items-center justify-center" onClick={() => navigate("/about")}>
                                    <span className="absolute inset-0 bg-blue-600 w-0 group-hover:w-full transition-all duration-500 ease-out"></span>
                ...
                <section className="relative py-10 sm:py-12 md:py-14 lg:py-16 bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-hidden">
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div data-aos="fade-up" className="text-center mb-8 md:mb-14">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto mt-6 text-xs sm:text-sm md:text-base lg:text-md">
                                We are driven by principles that ensure the highest level of patient care, trust, and innovation.
                            </p>
                        </div>
                ...
                <section data-aos="fade-up" className="relative py-10 sm:py-12 md:py-14 lg:py-16 bg-gray-900">
                    {/* Background Image with Overlay */}
